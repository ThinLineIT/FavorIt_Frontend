...
import NewFundingCloseModal from '../modal/NewFundingCloseModal';
import useModal from '@hooks/useModal';

interface OpnedDetailPageProps {
  data?: FundDetailModel;
}

function OpendDetailPage({ data }: OpnedDetailPageProps) {
  ...
  const onClickRibbonHandler = () => {
    openModal(<NewFundingCloseModal />);
  };
...
export default OpendDetailPage;
